...
<template>
    <div class="[--placement:bottom-left] hs-dropdown relative inline-flex">
        <button id="hs-language-switcher" type="button" class="hs-dropdown-toggle py-3 px-3 inline-flex justify-center items-center align-middle gap-2 rounded-md border border-gray-200 font-medium bg-white hover:bg-gray-100 text-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-all text-sm">
        ...
        <div class="hs-dropdown-menu border z-50 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden bg-white shadow-sm rounded-lg p-2 mt-2 divide-y divide-gray-200"
