...
<template>
    <div class="[--placement:bottom-left] hs-dropdown relative inline-flex">
        <button id="hs-language-switcher" type="button" class="hs-dropdown-toggle py-3 px-3 inline-flex justify-center items-center align-middle gap-2 rounded-md border border-gray-200 font-medium bg-white hover:bg-gray-100 text-gray-700 shadow-sm focus:outline-none focus:ring-2 focus:ring-gray-800 focus:ring-offset-2 transition-all text-sm">
        ...
        <div class="hs-dropdown-menu border z-50 transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden bg-white shadow-md rounded-lg p-2 mt-2 divide-y divide-gray-200"
             aria-labelledby="hs-language-switcher">
            <div class="py-2 first:pt-0 last:pb-0">
                <a class="flex items-center gap-x-3 py-2.5 px-3 cursor-pointer rounded-md text-sm text-gray-700 hover:bg-gray-100"
